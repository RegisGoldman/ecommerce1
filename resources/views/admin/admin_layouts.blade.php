...
<div class="sl-sideleft">
    ...
    <ul class="sl-menu-sub nav flex-column">
        <li class="nav-item"><a href="{{ route('categories') }}" class="nav-link">Catégorie</a></li>
        <li class="nav-item"><a href="{{route('sub.categories')}}" class="nav-link">Sous Catégorie</a></li>
        <li class="nav-item"><a href="{{route('brands')}}" class="nav-link">Marque</a></li>
    </ul>
    @else
    @endif
    ...
    <ul class="sl-menu-sub nav flex-column">
        <li class="nav-item"><a href="{{ route('add.product') }}" class="nav-link">Ajouter un produit</a></li>
        <li class="nav-item"><a href="{{ route('all.product') }}" class="nav-link">Tous les produits</a></li>
    </ul>
    @else
    @endif
...
<div class="sl-header">
    ...
    <nav class="nav">
        ...
        <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
            ...
            <img src=" {{asset('public/backend/img/black_man.jpg')}} " class="wd-32 rounded-circle" alt="">
        </a>
