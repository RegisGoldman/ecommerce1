...
<div class="sl-pagebody">
    ...
    <div class="table-wrapper">
        ...
        <tbody>
            ...
            <td>
                <a href=" {{ URL::to('edit/category/'.$row->id) }} " class="btn btn-sm btn-info">Modifier</a>
                <a href=" {{ URL::to('delete/category/'.$row->id) }} " class="btn btn-sm btn-danger" id="delete">Supprimer</a>
            </td>
            </tr>
